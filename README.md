...
| 팀원 | 역할 | 주요 담당 | GitHub |
|------|------|-----------|--------|
| 전지연 | 팀장, PM, FE | 채팅 | [@jeonjyeon](https://github.com/jeonjyeon) |
| 조장원 | 디자이너, PL, FE | 채팅 | [@Jandi95](https://github.com/Jandi95) |
| 성정은 | QA, FE | 로그인/회원가입, 내 정보 | [@jeongeunsung](https://github.com/jeongeunsung) |
| 이형민 | 발표자, FE | 동행찾기, 동행신청 | [@hunky1st](https://github.com/hunky1st) |
...
- DB 설계 및 점검
- 전체 DB CRUD 테스트
- 공통 컴포넌트 제작 (GNB, 링크, 페이지네이션)
- 채팅 목록 페이지 구현
- 동행 찾기 목록 드롭다운 적용
- 프로젝트 배포, Notion 관리 및 README 제작

#### 👨‍💻 조장원
- 기획 및 UI 디자인
- 프로젝트 초기 세팅 및 구조 설계
- DB 점검 및 CRUD 테스트
- 공통 컴포넌트 제작 (SVG, 버튼, 모달 다이얼로그, 레이아웃)
- 실시간 채팅 및 게시글 수정 페이지 개발

#### 👩‍💻 성정은
- 기획 및 테스트
- 로그인/회원가입, 내 정보 페이지 구현
- 기능 QA 및 품질 점검
